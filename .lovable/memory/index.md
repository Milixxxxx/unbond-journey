...
**Kapitelkopf**: KEIN großes Hero-Bild oben. Reihenfolge: Kapiteltitel → 2–3 einleitende Sätze (Hook im `ChapterIntro`) → optional Quick-Tools-Trio → Mary-&-Sandra-Story. KEINE neuen Kapitelelemente erfinden (keine extra Hook-/„Die eine Frage"-Karten).
...
**Mary-&-Sandra-Bilder**: IMMER `float-left` neben dem dazugehörigen Textabschnitt (mit Textumfluss rechts), nie volle Breite, nie zentriert. **Genau EIN Mary-&-Sandra-Bild pro Geschichte/Seite** — nicht mehrere stapeln. Mobile fällt auf Block-Layout zurück. Das Story-Bild ist das ERSTE Bild im Kapitel.
