...
**Mary-&-Sandra-Bilder**: IMMER `float-left` neben dem dazugehörigen Textabschnitt (mit Textumfluss rechts), nie volle Breite, nie zentriert. Mobile fällt auf Block-Layout zurück. Quellbilder: src/assets/mary-sandra-cafe.jpg.asset.json, src/assets/book/mary-sandra-intro.png.asset.json, src/assets/book/mary-erste-nacht.png.asset.json.
