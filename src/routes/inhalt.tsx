...
const ITEMS: Item[] = [
  ...
  },
  {
    ...
    sub: "24-Stunden-Überleben – TIPP-Protokoll (DBT) – STOPP-Technik – Notfallplan",
    to: "/modul/$slug",
  ...
  },
  {
    ...
    sub: "10 Warnsignale – Intermittierende Verstärkung – Spielautomaten-Effekt – ACT-Defusion",
    to: "/modul/$slug",
    slug: "modul-01",
  },
  {
    num: "Schritt 03",
    title: "Rosa-Brille",
    sub: "Kognitive Dissonanz – Negative Reappraisal – 4-Spalten-Realitätscheck – Narrativ-Tafel",
    to: "/modul/$slug",
    slug: "modul-02",
  },
  {
  ...
  },
  {
    ...
    sub: "Bindungsstile – Anxious-Avoidant-Tanz – Reactive Abuse – Sichere Bindung aufbauen",
    to: "/modul/$slug",
    slug: "modul-08",
  },
  {
    ...
    sub: "Werte-Kompass – Narrativ neu schreiben – Brief ans zukünftige Ich – Kintsugi-Manifest",
    to: "/modul/$slug",
    slug: "modul-09",
  },
  {
    ...
    sub: "Litigation Abuse – DARVO – Dokumentation – Rechtliche Vorsorge – Notfall-Netzwerk",
    to: "/modul/$slug",
    slug: "bonus-d",
  },
  {
    num: "Bonus E",
    title: "Bonus E · Warum",
    sub: "Schema-Therapie (Young) – IFS-Parts (Schwartz) – Tiefenschichten der Bindungswahl",
    to: "/modul/$slug",
    slug: "bonus-e",
  },
  {
    ...
    sub: "Disenfranchised Grief – 5 Verlustebenen – finale Kintsugi-Apotheose",
    to: "/modul/$slug",
    slug: "bonus-f",
  },
];
