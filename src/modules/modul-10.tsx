      ...
      >
        <div className="rounded-2xl bg-white/70 p-4 text-sm leading-relaxed text-graphite/85 shadow-glass">
          ...
          <p className="mt-3" style={{ marginBottom: 0 }}>
            Und für lesbische Frauen kommt eine sechste, ganz konkrete Schicht
            dazu: <strong>queere Klarheit.</strong> Du weißt jetzt, wie sich
            ungesunde Fusion in einem identifikatorischen Raum anfühlt — und
            was sie von echter Nähe unterscheidet. Das ist eine
            Unterscheidungsfähigkeit, die viele nie lernen müssen. Du musstest
            sie lernen. Und du <em>hast</em> sie gelernt.
          </p>
        </div>
      </Section>
